...
// // technically n2 (34567.2345) is decimal number i want to get number from  decimal value??
// // parseInt()
// var n3 = parseInt(n2);
// console.log('n3=>' ,n3)//345676
...
// for(var k =0;k<10;k++) {
//     var ran =  Math.random()*10; //0 to 10 without 10 if we use Math.ceil() then it includes 10
...
// console.log('float', parseInt(numeric1))//1245
// console.log('float', +numeric1)//1245.55
// console.log('float', parseFloat(numeric1))//1245.55
...
var a12 = parseInt(a11);//234
var a13 = parseInt(b11);//23
var a14=  parseInt(b12)//NaN
...
//=========================isNaN works according to + convertor=======================================//
