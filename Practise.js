...
// //  console.log(1<2<3)//(true i.e. 1 <3)===>true
// //  console.log(3>2>1) //(true i.e 1>1)===> false
...
// //  console.log("a">"2"); // same string data type compares ASCII VALUUES  // true
